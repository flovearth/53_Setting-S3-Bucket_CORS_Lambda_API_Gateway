...
- Create a bucket of `flovearth.broadcast` with following properties,
...
<CORSRule>
    <AllowedOrigin>http://flovearth.broadcast.s3-website.eu-central-1.amazonaws.com</AllowedOrigin>
